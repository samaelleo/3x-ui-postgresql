...
// GetDBType returns the database type configured via XUI_DB_TYPE. Defaults to "sqlite".
...
// GetDBURI returns the database connection URI configured via XUI_DB_URI.
func GetDBURI() string {
	return os.Getenv("XUI_DB_URI")
}
